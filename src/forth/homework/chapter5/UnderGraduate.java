package forth.homework.chapter5;
...
public class UnderGraduate extends Student{
    ...
    public UnderGraduate(String no,String name,String major,String electiveCourse) {
        super(no,name,major);
    ...
    public void getInfo() {
        System.out.println("Sno : " + getNo() + " Name : " + getName() + " Major : " + getMajor() + " Course : " + electiveCourse);
    }
